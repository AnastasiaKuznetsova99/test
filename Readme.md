...
### Создать и перейти на только что созданную ветку

Коменда ***git checkout -b*** *"название ветки"* позволяет выполнить сразу два действия *создать* и *перейти* на ветку.
